...
public class TestKandyWebElementActionsWithPageObject {
	...
	public void licenseTest(){
		goTo("https://online.nzta.govt.nz/licence-test/identification");
		webDriver().findElement(By.xpath("//input[@formcontrolname='LicenceNumber']")).sendKeys("EE292017");
		webDriver().findElement(By.xpath("//input[@formcontrolname='LicenceVersion']")).sendKeys("355");
		webDriver().findElement(By.xpath("//input[@formcontrolname='LastName']")).sendKeys("Ladduwahetty");
		webDriver().findElement(By.xpath("//input[@formcontrolname='DateOfBirth']")).sendKeys("22-06-1984");
